...
namespace GUIminre
{
    public partial class Form12 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            connection1.Open();
            int ci = 0;
            MySqlCommand command1 = new MySqlCommand("SELECT * FROM MANAGEMENT", connection1);
            ...
            string insertQuery = "INSERT INTO MANAGEMENT VALUES('" + ci + "','" + fnTB.Text + "','" + lnTB.Text + "','" + gender + "','" + posTB.Text +"','" + ph +"','"+ emailTB.Text + "');";
            connection.Open();
        ...
        private void phTB_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
        ...
        {
            string delQuery = "DELETE FROM MANAGEMENT WHERE M_ID = @ID";
            MySqlCommand delcmd = new MySqlCommand(delQuery, connection3);
            delcmd.Parameters.AddWithValue("@ID", listView1.SelectedItems[0].Text);
